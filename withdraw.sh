...
if [ -f http/withdraw_list ];then
	for USER in $(cat http/withdraw_list|sed -r "s/\s+//g");do
		...
		curl -b "ItDoor=xiaolin;" -b $COOKIE_FILE 'http://che.zhongchoucar.com/Info/T493000657/Front/UserPage/UserGetMoney.aspx' -H 'Origin: http://che.zhongchoucar.com' -H 'Accept-Encoding: gzip, deflate' -H 'Accept-Language: zh-CN,zh;q=0.8,en;q=0.6' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 Safari/537.36' -H 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8' -H 'Accept: */*' -H 'Referer: http://che.zhongchoucar.com/Info/T493000657/Front/UserPage/UserZhongChou.aspx' -H 'X-Requested-With: XMLHttpRequest' -H 'Connection: keep-alive' --compressed > http/withdraw_$NAME
		...
		if [ $(echo "$AMOUNT > 0"|bc) -ge 1 ];then
			...
			RET=$(curl -b "ItDoor=xiaolin;" -b $COOKIE_FILE 'http://che.zhongchoucar.com/Info/T493000657/Front/UserPage/Ajax/UserGetMoney/MoneyOption.ashx' -H 'Origin: http://che.zhongchoucar.com' -H 'Accept-Encoding: gzip, deflate' -H 'Accept-Language: zh-CN,zh;q=0.8,en;q=0.6' -H 'User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 Safari/537.36' -H 'Content-Type: application/x-www-form-urlencoded; charset=UTF-8' -H 'Accept: */*' -H 'Referer: http://che.zhongchoucar.com/Info/T493000657/Front/UserPage/UserGetMoney.aspx' -H 'X-Requested-With: XMLHttpRequest' -H 'Connection: keep-alive' --data "getMoney=$AMOUNT&payPwd=$PAYPASS&forbank=$BANK" --compressed)
